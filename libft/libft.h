...
void                ft_atoi_base8_long(unsigned long int num);
void                ft_atoi_base8_ll(unsigned long long int num);
void                ft_atoi_base8_short(unsigned short int num);
void                ft_atoi_base16x(unsigned int num);
void                ft_atoi_base16lx(unsigned long int num);
